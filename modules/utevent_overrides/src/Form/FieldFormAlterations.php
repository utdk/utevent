...
namespace Drupal\utevent_overrides\Form;
...
use Drupal\utevent_overrides\Config\ConfigOverrider;
...
class FieldFormAlterations implements ContainerInjectionInterface {
  ...
  /**
   * The utevent configuration overrider service.
   *
   * @var \Drupal\utevent_overrides\Config\ConfigOverrider
   */
  protected $uteventOverridesOverrider;

  /**
   * EntityTypeInfo constructor.
   *
   * @param \Drupal\utevent_overrides\Config\ConfigOverrider $utevent_overrides_overrider
   *   The utevent configuration overrider service.
   */
  public function __construct(ConfigOverrider $utevent_overrides_overrider) {
    $this->uteventOverridesOverrider = $utevent_overrides_overrider;
  }
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('utevent_overrides.overrider')
    );
  }
  ...
  public function fieldConfigEditFormAlter(array &$form, FormStateInterface $form_state, $form_id) {
    $allowed_media_bundles = $this->uteventOverridesOverrider->getImageMediaBundles();
